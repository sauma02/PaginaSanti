  ...
  <div class="card">
    ...
    <form method="post">
      <div class="input-container">
        <input type="#{type}" id="#{label}" required="required" name="txtUsuario"/>
        <label for="#{label}">Username</label>
        <div class="bar"></div>
      </div>
      <div class="input-container">
        <input type="#{type}" id="#{label}" required="required" name="txtClave"/>
        <label for="#{label}">Password</label>
        <div class="bar"></div>
      </div>
      <div class="button-container">
        <button name="btnIngresar" type="submit"><span>Go</span></button>
      </div>
