                    ...
                    <div class="col-lg-9  d-none d-lg-block">
                        <div class="horizontal-menu">
                            <nav>
                                <ul id="nav_menu">
                                    <li>
                                        <a href="<?php echo URL;?>home/volverAdmin"><i class="ti-dashboard"></i><span>Volver al inicio</span></a>
                                    </li>
                                    <li class="active">
                                    ...
                                    <li class="active">
                                        <a href="javascript:void(0)"><i class="ti-layout-sidebar-left"></i> <span>Gestionar Mascotas</span></a>
                                        <ul class="submenu">
                                            <li><a href="<?php echo URL;?>usuarioController/listarMascotas">Ver mascotas</a></li>
                                            <li><a href="<?php echo URL;?>usuarioController/registrarMascotaAdmin">Registrar mascotas</a></li>
                                        </ul>
                                    </li>
